...
const HotelCard = ({ hotel, onSelect, isSelected }) => (
    ...
    >
        ...
        <div className="mt-2 text-right">
             {/* Bạn có thể thêm giá phòng ở đây sau */}
...
const HotelSuggestion = ({ destinationId, onHotelSelect }) => {
    ...
    const handleSelectHotel = (hotel) => {
        ...
        onHotelSelect(newSelectedHotel); // Báo cho component cha biết lựa chọn
    };
    ...
    // Không hiển thị gì nếu không có khách sạn hoặc không có destinationId
    if (hotels.length === 0) {
        return null;
    }
